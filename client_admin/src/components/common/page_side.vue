<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/student/table" v-show="user_group == '管理员' || $check_action('/student/table')"><span>学生信息管理</span></el-menu-item>
			<el-menu-item index="/teacher/table" v-show="user_group == '管理员' || $check_action('/teacher/table')"><span>老师信息管理</span></el-menu-item>
			<el-menu-item index="/enterprise_users/table" v-show="user_group == '管理员' || $check_action('/enterprise_users/table')"><span>企业用户管理</span></el-menu-item>
			<!-- <el-menu-item index="/user_group/table"><span>用户组</span></el-menu-item> -->
		</el-submenu>
		<el-submenu index="content"
			v-show="user_group == '管理员' || $check_group([ '/article/table','/article_type/table','/exam/table'])">
