			...
			<el-row>
				<el-col>
					<el-form :model="form" ref="form" label-width="80px" class="form">
						...
						<!-- 老师 -->
						<form_teacher v-if="form.user_group === '老师'" :form="form_sub" ></form_teacher>
						<!-- 企业用户 -->
						<form_enterprise_users v-if="form.user_group === '企业用户'" :form="form_sub" ></form_enterprise_users>
...
<script>
	...
	/* 企业用户 */
	import form_enterprise_users from "@/components/diy/form_enterprise_users";
