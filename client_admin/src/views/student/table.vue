<template>
	<el-main class="bg">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="personal_profile" label="个人简介"
				v-if="user_group == '管理员' || $check_field('get','personal_profile')" min-width="200">
			</el-table-column>
			<el-table-column prop="full_name" label="姓名"
				v-if="user_group == '管理员' || $check_field('get','full_name')" min-width="200">
			</el-table-column>
			<el-table-column prop="certificate" label="证书"
				v-if="user_group == '管理员' || $check_field('get','certificate')" min-width="200">
				<template slot-scope="scope">
					<el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['certificate'])"
						:preview-src-list="[$fullUrl(scope.row['certificate'])]">
			...
			<el-table-column prop="registered_residence" label="户籍地"
				v-if="user_group == '管理员' || $check_field('get','registered_residence')" min-width="200">
			</el-table-column>
			...
			<el-table-column prop="graduation_school" label="毕业学校"
				v-if="user_group == '管理员' || $check_field('get','graduation_school')" min-width="200">
			</el-table-column>
			...
			<el-table-column prop="awards" label="获奖情况"
				v-if="user_group == '管理员' || $check_field('get','awards')" min-width="200">
			</el-table-column>
			<el-table-column prop="employment_intention" label="就业意向"
				v-if="user_group == '管理员' || $check_field('get','employment_intention')" min-width="200">
			</el-table-column>
			<el-table-column prop="social_practice" label="社会实践"
				v-if="user_group == '管理员' || $check_field('get','social_practice')" min-width="200">
			</el-table-column>
