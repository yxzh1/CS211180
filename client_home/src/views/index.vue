        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="diy_recommend">
              ...
              <div class="more_box">
                <router-link to="/recruitment_information/list" class="more">
                  <span>更多</span>
                </router-link>
              </div>
              <div class="switch" @click="show_list_recruitment_information = !show_list_recruitment_information">
                <div class="switch_box">
                  <span v-if="show_list_recruitment_information"> 切换表格 </span>
                  <span v-else> 切换列表 </span>
                </div>
              </div>
            </div>
            <!--招聘信息推荐列表组件 -->
            <list_recruitment_information v-if="show_list_recruitment_information"
                                          :list="list_recruitment_information"/>
            <div class="overflow-auto" v-else>
              <table id="list_diy" role="table" aria-busy="false"
                     :aria-colcount="fields_recruitment_information.length"
                     class="table b-table table-striped table-hover">
                <thead>
                <tr>
                  <th v-for="(o,i) in fields_recruitment_information" :key="i">
                    {{ o.label }}
                  </th>
                </tr>
                </thead>
                <tbody>
                <tr v-for="(o, i) in list_table_recruitment_information" :key="i"
                    @click="to_details('recruitment_information',o,'recruitment_information_id')">
                  <td v-for="(oj,n) in fields_recruitment_information">
                    <img v-if="oj.type && oj.type == '图片' " :src="$fullUrl(o[oj.key])" alt=""
                         v-default-img="'/img/default.png'">
                    <span v-else>{{ o[oj.key] }}</span>
                  </td>
...
export default {
  ...
  data() {
    return {
      ...
      show_list_recruitment_information: true,
      list_recruitment_information: [],
      vm_arr_recruitment_information: [
      ...
      fields_recruitment_information: [
        {
          key: "enterprise_name",
          label: "企业名称",
          type: "文本"
        ...
        {
          key: "enterprise_industry",
          label: "企业行业",
          type: "文本"
        },
        {
          key: "enterprise_picture",
          label: "企业图片",
          type: "图片"
        },
        {
        ...
        {
          key: "graduation_school_requirements",
          label: "毕业学校要求",
          type: "文本"
        },
        {
          key: "recruitment_occupation",
          label: "招聘职业",
          type: "文本"
        },
        {
  ...
  computed: {
    list_table_recruitment_information() {
