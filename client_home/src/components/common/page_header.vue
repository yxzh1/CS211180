              ...
              <div class="my_header">
                  ...
                  <ul>
                    ...
                    <li v-else-if="nav_top.length > top_max">
                      <div ref="more" class="more" @click="change()">
                        ...
                        <span class="caret" v-bind:style="{transform: 'rotate('+ angle1 +'deg)'}"/>
                      </div>
                ...
                <div ref="my" v-else class="user">
                  <div ref="own" class="own" @click="my()">
                    ...
                    <span class="caret" v-bind:style="{transform: 'rotate('+ angle2 +'deg)'}"/>
                  </div>
                ...
                <div ref="mini" class="mini_nav" @click="open_mini()">
                  <div ref="mini" class="mini">
                    ...
                    <span class="caret" v-bind:style="{transform: 'rotate('+ angle3 +'deg)'}"/>
                  </div>
                </div>
  ...
  methods: {
    ...
    async get_nav_top() {
      ...
      if (auth.length > 0) {
        ...
        this.nav_top = arr;
        console.log("arr-------> ", arr)
        console.log("nav_top-------> ", this.nav_top)
      } else {
